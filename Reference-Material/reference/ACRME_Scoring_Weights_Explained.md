...
- **Multi-Region Placement Design** (`Archive/research/multi_region_placement_design.md`) — lines 449–531, full formula definitions + weight table
- **Design Change Summary** (`Archive/research/design_change_summary.md`) — CR/CRG-7, lines 153–193, formula rationale
- **Production Readiness Review** (`Archive/design/acrme_production_readiness_review_and_architecture.md`) — Section 28 lines 1095–1160, corrected scoring model
- **ADR-001 Region Selection** (`Architecture/adr/acrme_adr_001_region_selection.md`) — corrected scoring model section
