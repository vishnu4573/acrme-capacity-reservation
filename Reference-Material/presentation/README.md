...
A 14-slide leadership deck distilling the [Executive Design Document](../../Archive/design/acrme_executive_design_document.md)
...
```bash
cd Reference-Material/presentation
