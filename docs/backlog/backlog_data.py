...
EPICS = [
    ...
    # =====================================================================
    {
        ...
        "stories": [
            ...
            {
                "id": "ACRME-S0706",
                "title": "Middle East two-region placement (DR_NOT_OFFERED; Switzerland North cross-geo path pre-configured but inactive)",
                "as_a": "placement owner",
                "i_want": "Middle East to place Prod + CVAL across its two in-geo regions with DR set to NOT_OFFERED, and the Switzerland North cross-geo path pre-configured but inactive until DEC-001 clears",
                "so_that": "Middle East deployments comply with the current DR_NOT_OFFERED legal position (DEC-001) while a compliant DR path is ready to enable by config if approved",
                "priority": "High", "points": 5, "phase": "P1",
                "prr_refs": ["§27 Middle East", "HC-10", "R-12", "DR-014", "DEC-001", "PLC-010a"],
                ...
                "tasks": [
                    {"id": "ACRME-T070601", "title": "Implement Middle East Prod/CVAL in-geo assignment (two-region)"},
                    {"id": "ACRME-T070602", "title": "Implement DR_NOT_OFFERED handling + pre-configured (inactive) Switzerland North cross-geo path gated on DEC-001"},
                    {"id": "ACRME-T070603", "title": "Block + alert on degraded extension path when active (no substitution)"},
                ],
            },
            {
                "id": "ACRME-S0707",
